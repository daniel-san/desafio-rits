...
$("input#telephone").on("focusout", function () {
...
$("input#linkedinUrl").on("focusout", function () {
  valid = validate_empty("input#linkedinUrl")();

  if (!valid) {
    $("#linkedin-error").text("Por favor digite o endereço do seu LinkedIn");
    return false;
  }

  $("#linkedin-error").text("");
});
$("input#githubUrl").on("focusout", function () {
...
$("input#salary").on("focusout", function () {
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/vagaform.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/daniel/Projects/Laravel/desafio-rits/resources/js/vagaform.js */"./resources/js/vagaform.js");
